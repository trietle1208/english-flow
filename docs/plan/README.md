...
| 16  | [Grammar Schema v3](phase-16-grammar-schema-v3.md)               | Normalize grammar + learner-safe data layer (Server Actions)      | P1–P4 + license research done                     | ☑      |
| 17  | [Grammar Content Expansion](phase-17-grammar-content.md)         | ~15–20 topics; CEFR-J map; Tatoeba/TALPCo examples + attribution  | Seed ≥15 topics; attributed examples; exit gate   | ☑      |
